...
// export function c_L(x1, y1, x2, y2){
...
function c_layer_l_r(_rectList, _w, _h, _l, _t, _domPadding, _resLayer, isError) {
...
function u_layer_l_r(_rectList, _w, _h, _l, _t, _domPadding, _resLayer) {
    // alert(1)
